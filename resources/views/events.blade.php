    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="box-shadow: 0px 2px #3498db;">
                <div class="card-header">Job Utshob  2023 Services </div>
                <p class="m-3">Resume Screening & Job Readiness Training Fee: 200 BDT for Students and 500 BDT for Alumni</p>
                <div class="card-body">
