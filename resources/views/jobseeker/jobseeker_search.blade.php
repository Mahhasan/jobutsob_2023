                    ...
                    <table  width="100%" class="table table-striped table-sm table-bordered table-hover" id="jobseeker">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>{{$value->skill}}</td>
                                <td> <a class="btn btn-sm btn-success" href="/resume/{{$value->resume}}" type="button" target="_blank">Download CV</a></td> 
                                <td>{{ \Carbon\Carbon::parse($value->created_at)->format('d/m/Y') }}</td>
                                <td>
                                <a class="btn btn-sm btn-danger" href="{{ route('approve',$value->id) }}" type="button" >View</a></td>
