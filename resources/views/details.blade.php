      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card animate__animated animate__zoomIn" style="box-shadow: 0px 2px #3498db;">
            <img class="card-img-top logo" src="/logo/{{  \App\Models\Company::find($job->company)->logo }}" alt="{{  \App\Models\Company::find($job->company)->name }}"/>
            <div class="col-md-6">
              <a href="{{ route('jobs.show',$job->id) }}" class="btn btn-danger   animate__animated animate__zoomIn glow">Click Here To Apply</a>
            </div>
            <div class="card-body">
